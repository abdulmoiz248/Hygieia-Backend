...
export function generateAppointmentConfirmationEmail(data: AppointmentDto): string {
  ...
  <html lang="en">
    <head>
      ...
      <title>Hygieia Appointment Confirmation</title>
      <style>
        body {
          margin: 0;
          padding: 0;
                              ...
                              <table cellpadding="0" cellspacing="0" border="0" style="margin-top:20px;">
                                <tr>
                                  <td style="background-color:#f5f5f5; border-radius:12px; padding:15px; text-align:left; line-height:1.5; color:#17433b;" class="instructions">
                                    ...
                                    <ul>
                                      <li>Make sure you have <strong>Zoom</strong> installed and updated.</li>
                                      <li>Test your <strong>camera</strong> and <strong>microphone</strong> beforehand.</li>
                                      <li>Join the meeting <strong>5-10 minutes early</strong> to avoid any delays.</li>
                                      <li>Ensure you’re in a <strong>quiet, well-lit space</strong> for the consultation.</li>
                                      <li>Click the “Join Appointment” button below when it’s time.</li>
                                    </ul>
                                  </td>
                                </tr>
                              </table>
                                ...
                                <tr>
                                  <td style="background-color:#f5f5f5; border-radius:12px; padding:15px; text-align:left; line-height:1.5; color:#17433b;" class="instructions">
                                    ...
                                    <ul>
                                      ...
                                      <li>Wear a mask and follow safety protocols.</li>
                                      <li>Reschedule your appointment if you are unable to attend from the website.</li>
                                    </ul>
                                  </td>
                                </tr>
                              </table>
